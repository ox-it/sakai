...
public class ReportingPermissionsImplTest extends BaseTestEvalLogic {
   ...
   public void testGetViewableGroupsForEvalAndUserByRole_activeIgnoreViewDates() {
	  ...
	  evalGroupIds = reportingPermissions.getViewableGroupsForEvalAndUserByRole(eval, EvalTestDataLoad.MAINT_USER3_ID, null);
	  assertNotNull(evalGroupIds);
	  assertEquals(1, evalGroupIds.size());
	  assertTrue( evalGroupIds.contains(etdl.assign14.getEvalGroupId()) );

	  //test normal user can view active evaluation
	  evalGroupIds = reportingPermissions.getViewableGroupsForEvalAndUserByRole(eval, EvalTestDataLoad.USER4_ID, null);
	  assertNotNull(evalGroupIds);
	  assertEquals(1, evalGroupIds.size());
	  assertTrue( evalGroupIds.contains(etdl.assign14.getEvalGroupId()) );
   }
   ...
   public void testGetViewableGroupsForEvalAndUserByRole_dueIgnoreViewDates() {
	  ...
	  assertNotNull(evalGroupIds);
	  assertEquals(1, evalGroupIds.size());
	  assertTrue( evalGroupIds.contains(etdl.assign12.getEvalGroupId()) );
   ...
   public void testGetViewableGroupsForEvalAndUserByRole_closedIgnoreViewDates() {
	  ...
	  assertNotNull(evalGroupIds);
	  assertEquals(1, evalGroupIds.size());
	  assertTrue( evalGroupIds.contains(etdl.assign13.getEvalGroupId()) );
