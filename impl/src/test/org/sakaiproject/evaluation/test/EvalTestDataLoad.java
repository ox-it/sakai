...
public class EvalTestDataLoad {
    ...
    /**
     * Template used for testing ignore view dates, private, EVALSYS_1007_USER_ID_01 owns, locked
     * <br/>Uses {@link #item1} and {@link #item5}
     */
    ...
    /**
     * Evaluation for testing getEvaluationsForUser 
     * evaluation in its grace period 
     */
    public EvalEvaluation evaluation_gracePeriod_inGracePeriod;
    /**
     * Evaluation for testing getEvaluationsForUser 
     * evaluation NOT in its grace period 
     */
    public EvalEvaluation evaluation_gracePeriod_notInGracePeriod;
    /**
   ...
   /**
     * Group Assignment: MAIN_USER_ID_6, SITE7_REF
     * {@link #evaluation_gracePeriod_inGracePeriod}
     */
    public EvalAssignGroup assign18;
    /**
     * Group Assignment: MAIN_USER_ID_6, SITE7_REF
     * {@link #evaluation_gracePeriod_notInGracePeriod}
     */
    public EvalAssignGroup assign19;
    ...
    public void initializeAndSave(GenericDao dao) {
        ...
        evaluationGracePeriod = new EvalEvaluation(EvalConstants.EVALUATION_TYPE_EVALUATION, 
                ...
                templateAdmin, null, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, EvalTestDataLoad.LOCKED,
                EvalConstants.EVALUATION_AUTHCONTROL_NONE, null, null);
        ...
        evaluation_simpleAssignments_allRolesParticipate = new EvalEvaluation(EvalConstants.EVALUATION_TYPE_EVALUATION, 
                ...
                EvalConstants.EVALUATION_AUTHCONTROL_AUTH_REQ, null, null,Boolean.FALSE);
        /*
         * Evaluation which has allRolesCanParticipate set to false
         * Site 3 group has 1 maintain and 1 access user
         * maintain user with evaluatee assignment
         ...
         * evaluation in its grace period 
         */
        evaluation_gracePeriod_inGracePeriod = new EvalEvaluation(EvalConstants.EVALUATION_TYPE_EVALUATION, 
                EvalTestDataLoad.ADMIN_USER_ID, "evaluation_gracePeriod_inGracePeriod", null, 
                threeDaysAgo, yesterday, 
                tomorrow, null, false, null,
                false, null, 
                EvalConstants.EVALUATION_STATE_GRACEPERIOD, EvalConstants.SHARING_VISIBLE, EvalConstants.INSTRUCTOR_OPT_IN, Integer.valueOf(2), null, null, null, null,
                templateAdmin, null, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE,
         ...
         * evaluation NOT in its grace period 
         */
        evaluation_gracePeriod_notInGracePeriod = new EvalEvaluation(EvalConstants.EVALUATION_TYPE_EVALUATION, 
                EvalTestDataLoad.ADMIN_USER_ID, "evaluation_gracePeriod_notInGracePeriod", null, 
                yesterday, tomorrow, 
                threeDaysFuture, null, false, null,
                false, null, 
                EvalConstants.EVALUATION_STATE_ACTIVE, EvalConstants.SHARING_VISIBLE, EvalConstants.INSTRUCTOR_OPT_IN, Integer.valueOf(2), null, null, null, null,
                templateAdmin, null, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE,
                EvalTestDataLoad.LOCKED, EvalConstants.EVALUATION_AUTHCONTROL_AUTH_REQ, null, null);
        ...
        //evaluationused to to accessibility when in grace period
        dao.save(evaluation_gracePeriod_inGracePeriod);
        dao.save(evaluation_gracePeriod_notInGracePeriod);
        ...
        assign18 = new EvalAssignGroup(MAINT_USER_ID_6, SITE7_REF, EvalConstants.GROUP_TYPE_SITE,
        		evaluation_gracePeriod_inGracePeriod, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE);
        assign19 = new EvalAssignGroup(MAINT_USER_ID_6, SITE7_REF, EvalConstants.GROUP_TYPE_SITE,
        		evaluation_gracePeriod_notInGracePeriod, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE);
        ...
        if (counter != 41) {
            throw new IllegalStateException("Invalid user assignments creation, 41 != " + counter);
        }
