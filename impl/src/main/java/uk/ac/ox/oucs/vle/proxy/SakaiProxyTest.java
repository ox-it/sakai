...
public class SakaiProxyTest implements SakaiProxy {
	...
	public SakaiProxyTest() {
		...
		users.add(new UserProxy("current", "user", null, null, "Current User", "current.user@coll.ox.ac.uk", null, null, null, null, null, Collections.singletonList("Some College"), null));
		
		users.add(new UserProxy("1", "user0001", null, null, "Test User One", "test.user.1@dept.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));
		users.add(new UserProxy("2", "user0002", null, null, "Test User Two", "test.user.2@dept.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));

		// So some imports work.
		users.add(new UserProxy("3", "bras1760", null, null, "Katherine Allen", "katherine.allen@bnc.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));
		
		users.add(new UserProxy("d86d9720-eba4-40eb-bda3-91b3145729da", "socs0001", null, null, "Course Admin 1", "course.admin.1@dept.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));
		users.add(new UserProxy("c10cdf4b-7c10-423c-8319-2d477051a94e", "socs0002", null, null, "Course Admin 2", "course.admin.2@dept.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));
		
		
		// Bulk load of users.
		for (int i = 1; i <=50; i++) {
			users.add(new UserProxy("id"+i, "eid"+i, null, null, "Full Name "+ i, "user"+i+"@dept.ox.ac.uk", null, null, null, null, null, Collections.EMPTY_LIST, null));
		}
		current = users.get(0);
	}
