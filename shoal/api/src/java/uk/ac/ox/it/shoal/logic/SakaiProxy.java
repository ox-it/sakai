...
public interface SakaiProxy {
	...
	/**
	 * Get's the current teaching item that should be displayed/edited.
	 * @return A teaching item, never <code>null</code>.
	 */
	TeachingItem getTeachingItem();

	/**
	 * Saves the current teaching item.
	 * @param model The teaching item to be saved, should never be <code>null</code>.
	 */
	void saveTeachingItem(TeachingItem model);
	 ...
	 * @throws IOException
	 */
	String saveThumbnail(InputStream inputStream) throws IOException;
