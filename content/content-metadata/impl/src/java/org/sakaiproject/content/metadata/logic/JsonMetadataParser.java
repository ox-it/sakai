...
public class JsonMetadataParser implements MetadataParser {
	...
	{
		/**
		 *  FIXME: The ContextClassLoader is switched in order to work with {@link com.fasterxml.jackson.map.jsontype.impl#typeFromId(String)}
		...
		try
		{
			...
			objectMapper.addMixInAnnotations(MetadataType.class, MetadataTypeMixin.class);
			objectMapper.addMixInAnnotations(ListMetadataType.class, ListMetadataTypeMixin.class);
