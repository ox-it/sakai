-- OWL 10.3-owl6 -> 11.3-owl1 Oracle conversion script
-- ---------------------------------------------------
...
-- Rename DW_* tables
ALTER TABLE DW_ASSIGNMENT_STATUS RENAME TO OLD__DW_ASSIGNMENT_STATUS;
ALTER TABLE DW_CONTENT_RESOURCE_LOCK RENAME TO OLD__DW_CONTENT_RESOURCE_LOCK;
ALTER TABLE DW_GUIDANCE RENAME TO OLD__DW_GUIDANCE;
ALTER TABLE DW_GUIDANCE_ITEM RENAME TO OLD__DW_GUIDANCE_ITEM;
ALTER TABLE DW_GUIDANCE_ITEM_FILE RENAME TO OLD__DW_GUIDANCE_ITEM_FILE;
ALTER TABLE DW_MATRIX RENAME TO OLD__DW_MATRIX;
ALTER TABLE DW_MATRIX_CELL RENAME TO OLD__DW_MATRIX_CELL;
ALTER TABLE DW_METAOBJ_FORM_DEF RENAME TO OLD__DW_METAOBJ_FORM_DEF;
ALTER TABLE DW_PRES_ITEMDEF_MIMETYPE RENAME TO OLD__DW_PRES_ITEMDEF_MIMETYPE;
ALTER TABLE DW_PRESENTATION RENAME TO OLD__DW_PRESENTATION;
ALTER TABLE DW_PRESENTATION_COMMENT RENAME TO OLD__DW_PRESENTATION_COMMENT;
ALTER TABLE DW_PRESENTATION_ITEM RENAME TO OLD__DW_PRESENTATION_ITEM;
ALTER TABLE DW_PRESENTATION_ITEM_DEF RENAME TO OLD__DW_PRESENTATION_ITEM_DEF;
ALTER TABLE DW_PRESENTATION_ITEM_PROPERTY RENAME TO OLD__DW_PRESENTATION_ITEM_PROP;
ALTER TABLE DW_PRESENTATION_LAYOUT RENAME TO OLD__DW_PRESENTATION_LAYOUT;
ALTER TABLE DW_PRESENTATION_LOG RENAME TO OLD__DW_PRESENTATION_LOG;
ALTER TABLE DW_PRESENTATION_PAGE RENAME TO OLD__DW_PRESENTATION_PAGE;
ALTER TABLE DW_PRESENTATION_PAGE_ITEM RENAME TO OLD__DW_PRESENTATION_PAGE_ITEM;
ALTER TABLE DW_PRESENTATION_PAGE_REGION RENAME TO OLD__DW_PRESENTATION_PAGE_REG;
ALTER TABLE DW_PRESENTATION_TEMPLATE RENAME TO OLD__DW_PRESENTATION_TEMPLATE;
ALTER TABLE DW_RESOURCE RENAME TO OLD__DW_RESOURCE;
ALTER TABLE DW_RESOURCE_COLLECTION RENAME TO OLD__DW_RESOURCE_COLLECTION;
ALTER TABLE DW_REVIEW_ITEMS RENAME TO OLD__DW_REVIEW_ITEMS;
ALTER TABLE DW_SCAFFOLDING RENAME TO OLD__DW_SCAFFOLDING;
ALTER TABLE DW_SCAFFOLDING_CELL RENAME TO OLD__DW_SCAFFOLDING_CELL;
ALTER TABLE DW_SCAFFOLDING_CELL_EVALUATORS RENAME TO OLD__DW_SCAFFOLDING_CELL_EVAL;
ALTER TABLE DW_SCAFFOLDING_CRITERIA RENAME TO OLD__DW_SCAFFOLDING_CRITERIA;
ALTER TABLE DW_SCAFFOLDING_LEVELS RENAME TO OLD__DW_SCAFFOLDING_LEVELS;
ALTER TABLE DW_SESSION RENAME TO OLD__DW_SESSION;
ALTER TABLE DW_SITE_USERS RENAME TO OLD__DW_SITE_USERS;
ALTER TABLE DW_SITES RENAME TO OLD__DW_SITES;
ALTER TABLE DW_TEMPLATE_FILE_REF RENAME TO OLD__DW_TEMPLATE_FILE_REF;
ALTER TABLE DW_USERS RENAME TO OLD__DW_USERS;
ALTER TABLE DW_WIZARD RENAME TO OLD__DW_WIZARD;
ALTER TABLE DW_WIZARD_CATEGORY RENAME TO OLD__DW_WIZARD_CATEGORY;
ALTER TABLE DW_WIZARD_COMPLETED RENAME TO OLD__DW_COMPLETED;
ALTER TABLE DW_WIZARD_COMPLETED_CATEGORY RENAME TO OLD__DW_WIZARD_COMP_CAT;
ALTER TABLE DW_WIZARD_COMPLETED_PAGE RENAME TO OLD__DW_COMPLETED_PAGE;
ALTER TABLE DW_WIZARD_PAGE RENAME TO OLD__DW_WIZARD_PAGE;
ALTER TABLE DW_WIZARD_PAGE_ATTACHMENTS RENAME TO OLD__DW_WIZARD_PAGE_ATT;
ALTER TABLE DW_WIZARD_PAGE_DEF RENAME TO OLD__DW_WIZARD_PAGE_DEF;
ALTER TABLE DW_WIZARD_PAGE_DEF_ADD_FORMS RENAME TO OLD__DW_WIZARD_PAGE_D_A_F;
ALTER TABLE DW_WIZARD_PAGE_FORMS RENAME TO OLD__DW_WIZARD_PAGE_FORMS;
ALTER TABLE DW_WIZARD_PAGE_SEQUENCE RENAME TO OLD__DW_WIZARD_PAGE_SEQUENCE;
ALTER TABLE DW_WIZARD_STYLE RENAME TO OLD__DW_WIZARD_STYLE;
ALTER TABLE DW_WIZARD_SUPPORT_ITEM RENAME TO OLD__DW_SUPPORT_ITEM;
ALTER TABLE DW_WORKFLOW_PARENT RENAME TO OLD__DW_WORKFLOW_PARENT;

-- Rename the ELL_* tables
ALTER TABLE ELL_CONFIGURATION RENAME TO OLD__ELL_CONFIGURATION;
ALTER TABLE ELL_MEETING_ACCESS RENAME TO OLD__ELL_MEETING_ACCESS;
ALTER TABLE ELL_MEETING_ACCESS_COURSE RENAME TO OLD__ELL_MEETING_ACCESS_COURSE;
ALTER TABLE ELL_MEETING_ACCESS_COURSE_TMP RENAME TO OLD__ELL_MEETING_ACC_CRS_TMP;
ALTER TABLE ELL_MEETING_ACCESS_PRIVATE RENAME TO OLD__ELL_MEETING_ACC_PRIV;
ALTER TABLE ELL_MEETING_ACCESS_PRIVATE_TMP RENAME TO OLD__ELL_MEETING_ACC_PRIV_TMP;
ALTER TABLE ELL_MEETING_ACCESS_SECTION RENAME TO OLD__ELL_MEETING_ACC_SEC;
ALTER TABLE ELL_MEETING_ACCESS_SECTION_TMP RENAME TO OLD__ELL_MEETING_ACC_SEC_TMP;
ALTER TABLE ELL_MEETING_ACCESS_TMP RENAME TO OLD__ELL_MEETING_ACCESS_TMP;
ALTER TABLE ELL_MEETING_METADATA RENAME TO OLD__ELL_MEETING_METADATA;
ALTER TABLE ELL_MEETING_METADATA_TMP RENAME TO OLD__ELL_MEETING_METADATA_TMP;
ALTER TABLE ELL_SESSION_DATA RENAME TO OLD__ELL_SESSION_DATA;
ALTER TABLE ELL_SESSION_DATA_TMP RENAME TO OLD__ELL_SESSION_DATA_TMP;

-- Rename the METAOBJ tables
ALTER TABLE METAOBJ_FORM_DEF RENAME TO OLD__METAOBJ_FORM_DEF;

-- Rename the OSP_* tables
ALTER TABLE OSP_AUTHZ_SIMPLE RENAME TO OLD__OSP_AUTHZ_SIMPLE;
ALTER TABLE OSP_COMPLETED_WIZ_CATEGORY RENAME TO OLD__OSP_COMPLETED_WIZ_CAT;
ALTER TABLE OSP_COMPLETED_WIZARD RENAME TO OLD__OSP_COMPLETED_WIZARD;
ALTER TABLE OSP_COMPLETED_WIZARD_PAGE RENAME TO OLD__OSP_COMPLETED_WIZARD_PAGE;
ALTER TABLE OSP_GUIDANCE RENAME TO OLD__OSP_GUIDANCE;
ALTER TABLE OSP_GUIDANCE_ITEM RENAME TO OLD__OSP_GUIDANCE_ITEM;
ALTER TABLE OSP_GUIDANCE_ITEM_FILE RENAME TO OLD__OSP_GUIDANCE_ITEM_FILE;
ALTER TABLE OSP_HELP_GLOSSARY RENAME TO OLD__OSP_HELP_GLOSSARY;
ALTER TABLE OSP_HELP_GLOSSARY_DESC RENAME TO OLD__OSP_HELP_GLOSSARY_DESC;
ALTER TABLE OSP_LIST_CONFIG RENAME TO OLD__OSP_LIST_CONFIG;
ALTER TABLE OSP_MATRIX RENAME TO OLD__OSP_MATRIX;
ALTER TABLE OSP_MATRIX_CELL RENAME TO OLD__OSP_MATRIX_CELL;
ALTER TABLE OSP_MATRIX_LABEL RENAME TO OLD__OSP_MATRIX_LABEL;
ALTER TABLE OSP_PORTAL_CATEGORY_PAGES RENAME TO OLD__OSP_PORTAL_CATEGORY_PAGES;
ALTER TABLE OSP_PORTAL_SITE_TYPES RENAME TO OLD__OSP_PORTAL_SITE_TYPES;
ALTER TABLE OSP_PORTAL_SPECIAL_SITES RENAME TO OLD__OSP_PORTAL_SPECIAL_SITES;
ALTER TABLE OSP_PORTAL_TOOL_CATEGORY RENAME TO OLD__OSP_PORTAL_TOOL_CATEGORY;
ALTER TABLE OSP_PORTAL_TOOL_FUNCTIONS RENAME TO OLD__OSP_PORTAL_TOOL_FUNCTIONS;
ALTER TABLE OSP_PORTAL_TOOL_TYPE RENAME TO OLD__OSP_PORTAL_TOOL_TYPE;
ALTER TABLE OSP_PRES_ITEMDEF_MIMETYPE RENAME TO OLD__OSP_PRES_ITEMDEF_MIMETYPE;
ALTER TABLE OSP_PRESENTATION RENAME TO OLD__OSP_PRESENTATION;
ALTER TABLE OSP_PRESENTATION_COMMENT RENAME TO OLD__OSP_PRESENTATION_COMMENT;
ALTER TABLE OSP_PRESENTATION_ITEM RENAME TO OLD__OSP_PRESENTATION_ITEM;
ALTER TABLE OSP_PRESENTATION_ITEM_DEF RENAME TO OLD__OSP_PRESENTATION_ITEM_DEF;
ALTER TABLE OSP_PRESENTATION_ITEM_PROPERTY RENAME TO OLD__OSP_PRESENTATION_ITM_PROP;
ALTER TABLE OSP_PRESENTATION_LAYOUT RENAME TO OLD__OSP_PRESENTATION_LAYOUT;
ALTER TABLE OSP_PRESENTATION_LOG RENAME TO OLD__OSP_PRESENTATION_LOG;
ALTER TABLE OSP_PRESENTATION_PAGE RENAME TO OLD__OSP_PRESENTATION_PAGE;
ALTER TABLE OSP_PRESENTATION_PAGE_ITEM RENAME TO OLD__OSP_PRESENTATION_PGE_ITM;
ALTER TABLE OSP_PRESENTATION_PAGE_REGION RENAME TO OLD__OSP_PRESENTATION_PAGE_REG;
ALTER TABLE OSP_PRESENTATION_TEMPLATE RENAME TO OLD__OSP_PRESENTATION_TEMPLATE;
ALTER TABLE OSP_REVIEW RENAME TO OLD__OSP_REVIEW;
ALTER TABLE OSP_SCAFFOLDING RENAME TO OLD__OSP_SCAFFOLDING;
ALTER TABLE OSP_SCAFFOLDING_ATTACHMENTS RENAME TO OLD__OSP_SCAFFOLDING_ATT;
ALTER TABLE OSP_SCAFFOLDING_CELL RENAME TO OLD__OSP_SCAFFOLDING_CELL;
ALTER TABLE OSP_SCAFFOLDING_CELL_FORM_DEFS RENAME TO OLD__OSP_SCAFFOLDING_C_F_D;
ALTER TABLE OSP_SCAFFOLDING_CRITERIA RENAME TO OLD__OSP_SCAFFOLDING_CRITERIA;
ALTER TABLE OSP_SCAFFOLDING_FORM_DEFS RENAME TO OLD__OSP_SCAFFOLDING_FORM_DEFS;
ALTER TABLE OSP_SCAFFOLDING_LEVELS RENAME TO OLD__OSP_SCAFFOLDING_LEVELS;
ALTER TABLE OSP_SITE_TOOL RENAME TO OLD__OSP_SITE_TOOL;
ALTER TABLE OSP_STYLE RENAME TO OLD__OSP_STYLE;
ALTER TABLE OSP_TEMPLATE_FILE_REF RENAME TO OLD__OSP_TEMPLATE_FILE_REF;
ALTER TABLE OSP_WIZ_PAGE_ATTACHMENT RENAME TO OLD__OSP_WIZ_PAGE_ATTACHMENT;
ALTER TABLE OSP_WIZ_PAGE_DEF_ATTACHMENTS RENAME TO OLD__OSP_WIZ_PAGE_DEF_ATT;
ALTER TABLE OSP_WIZ_PAGE_FORM RENAME TO OLD__OSP_WIZ_PAGE_FORM;
ALTER TABLE OSP_WIZARD RENAME TO OLD__OSP_WIZARD;
ALTER TABLE OSP_WIZARD_CATEGORY RENAME TO OLD__OSP_WIZARD_CATEGORY;
ALTER TABLE OSP_WIZARD_PAGE RENAME TO OLD__OSP_WIZARD_PAGE;
ALTER TABLE OSP_WIZARD_PAGE_DEF RENAME TO OLD__OSP_WIZARD_PAGE_DEF;
ALTER TABLE OSP_WIZARD_PAGE_SEQUENCE RENAME TO OLD__OSP_WIZARD_PAGE_SEQUENCE;
ALTER TABLE OSP_WORKFLOW RENAME TO OLD__OSP_WORKFLOW;
ALTER TABLE OSP_WORKFLOW_ITEM RENAME TO OLD__OSP_WORKFLOW_ITEM;
ALTER TABLE OSP_WORKFLOW_PARENT RENAME TO OLD__OSP_WORKFLOW_PARENT;
-- END OWL-2663
...
set HASAUTOSUBMISSIONRUN = 1
where assessmentgradingid in
(select ag.ASSESSMENTGRADINGID from SAM_ASSESSMENTGRADING_T ag, SAM_PUBLISHEDACCESSCONTROL_T pac
where ag.PUBLISHEDASSESSMENTID=pac.ASSESSMENTID
and pac.RETRACTDATE<=(SYSDATE-1)
and (ag.STATUS not in (5))
and (ag.HASAUTOSUBMISSIONRUN=0 or ag.HASAUTOSUBMISSIONRUN is null)
and pac.AUTOSUBMIT=1
