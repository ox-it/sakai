...
public class FinalGradesDataTable extends AjaxFallbackDefaultDataTable {
	 ...
	 */
	public FinalGradesDataTable(String id, final List<IColumn> columns, ISortableDataProvider dataProvider, boolean pageable, int pageSize)
	{
