...
public class GradeItemImportSelectionStep extends BasePanel {
	...
	public void onInitialize() {
		...
		// OWL - set up the previous selections, if any
		...
		final AjaxButton nextButton = new SakaiAjaxButton("nextbutton") {
			private static final long serialVersionUID = 1L;
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
				...
				importWizardModel.setSelectedGradeItems(itemsToProcess); // OWL - this is grades and comments now
