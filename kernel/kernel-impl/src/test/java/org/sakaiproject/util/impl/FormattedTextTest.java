...
public class FormattedTextTest {
    ...
    public void testProcessAnchor() {
    	...
    	Assert.assertEquals("<a  href=\"http://sakaiproject.org/\" target=\"_blank\" rel=\"noreferrer\">", formattedText
    ...
    public void testProcessAnchorRelative() {
        // Check we add the target attribute
    	Assert.assertEquals("<a  href=\"other.html\" target=\"_blank\" rel=\"noreferrer\">", formattedText
                .processAnchor("<a href=\"other.html\">"));
    }

    @Test
    public void testProcessAnchorMailto() {
    	Assert.assertEquals("<a  href=\"mailto:someone@example.com\" target=\"_blank\" rel=\"noreferrer\">", formattedText
                .processAnchor("<a href=\"mailto:someone@example.com\">"));
    }

    @Test
    public void testProcessAnchorName() {
    	Assert.assertEquals("<a  href=\"#anchor\" target=\"_blank\" rel=\"noreferrer\">", formattedText
    ...
    public void testTargetNotOverridden() {
    	...
    	Assert.assertEquals("<a  href=\"other.html\" target=\"_blank\" rel=\"noreferrer\">",
    	...
    	Assert.assertEquals("<a href=\"other.html\" target=\"_blank\" rel=\"noreferrer\">link</a>",
                formattedText.escapeHtmlFormattedText("<a href=\"other.html\">link</a>") );
    	Assert.assertEquals("<a href=\"other.html\" class=\"azeckoski\" target=\"_blank\" rel=\"noreferrer\">link</a>",
    	...
    	Assert.assertEquals("<a href=\"other.html\" class=\"azeckoski\" target=\"_blank\" rel=\"noreferrer\">link</a><a href=\"other.html\" target=\"_AZ\" class=\"azeckoski\">link</a>",
    	...
    	Assert.assertEquals("<b>simple</b><b class=\"AZ\">bold</b><a href=\"other.html\" class=\"azeckoski\" target=\"_blank\" rel=\"noreferrer\">link</a><a href=\"other.html\" target=\"_AZ\" class=\"azeckoski\">link</a>",
    ...
    public void testAntisamyProcessFormattedText() {
        ...
        //Assert.assertTrue( result.contains("target=\"_blank\"")); // adds target in
        Assert.assertTrue( result.contains("<div>hello there</div>"));
        Assert.assertEquals("<a href=\"blah.html\" style=\"font-weight: bold;\" target=\"_blank\" rel=\"noreferrer\">blah</a><div>hello there</div>", result);
