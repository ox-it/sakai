...
package org.sakaiproject.wicket.component.ajax.navigation.paging;
...
public class PagingNavigationIncrementButton extends Button
{
     ...
     *            increment by
     */
    public PagingNavigationIncrementButton(final String id, final IPageable pageable, final int increment)
    {
        super(id);
        setAutoEnable(true);
