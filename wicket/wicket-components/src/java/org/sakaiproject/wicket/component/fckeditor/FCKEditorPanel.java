...
package org.sakaiproject.wicket.component.fckeditor;
...
{
    private transient final Logger logger = Logger.getLogger(FCKEditorPanel.class);
     ...
     * @param stripContainingParagraphTags Set to true if you want the component to strip off the
