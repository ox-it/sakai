...
package org.sakaiproject.wicket.component.ajax.form;
...
public abstract class AjaxRolloverImageButton extends AjaxButton implements IHeaderContributor
{
    ...
    private static final ResourceReference ROLLOVER_SCRIPT = new CompressedResourceReference(AjaxRolloverImageButton.class,
            "resource/ajax-image-button-rollover.js");
