...
public class ClassicNavigatorLabel extends Label
{
    ...
    private ClassicNavigatorLabel(final String id, final PageableComponent table)
    {
        ...
        setDefaultModel(new StringResourceModel("NavigatorLabel", this, new Model(new LabelModelObject(table)),
                "${showingText} ${from} ${toText} ${to} ${ofText} ${of} ${suffixText}"));
    }
    ...
    private class LabelModelObject implements IClusterable
    {
        ...
        private final ResourceModel showingModel;
        private final ResourceModel ofModel;
        private final ResourceModel toModel;
        private final ResourceModel suffixModel;
