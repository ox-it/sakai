...
public interface SectionDataIfc
  ...
  public static final Integer QUESTIONS_AUTHORED_ONE_BY_ONE= Integer.valueOf(1);
  public static final Integer RANDOM_DRAW_FROM_QUESTIONPOOL= Integer.valueOf(2);

  public static final String QUESTIONS_ORDERING = "QUESTIONS_ORDERING"; // question ordering within a part
  public static final Integer AS_LISTED_ON_ASSESSMENT_PAGE= Integer.valueOf(1);
  public static final Integer RANDOM_WITHIN_PART= Integer.valueOf(2);
