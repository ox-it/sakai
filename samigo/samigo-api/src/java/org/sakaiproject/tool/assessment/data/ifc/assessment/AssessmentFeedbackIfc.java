    ...
    extends java.io.Serializable
{
  ...
  public static final Integer IMMEDIATE_FEEDBACK = Integer.valueOf(1);
  public static final Integer FEEDBACK_BY_DATE = Integer.valueOf(2);
  public static final Integer NO_FEEDBACK = Integer.valueOf(3);
  public static final Integer FEEDBACK_ON_SUBMISSION = Integer.valueOf(4);

  public static final Integer QUESTIONLEVEL_FEEDBACK = Integer.valueOf(1);
  public static final Integer SECTIONLEVEL_FEEDBACK = Integer.valueOf(2);
  public static final Integer BOTH_FEEDBACK = Integer.valueOf(3);
  public static final Integer SELECT_COMPONENTS = Integer.valueOf(2);  // select feedback components
  public static final Integer SHOW_TOTALSCORE_ONLY = Integer.valueOf(1);  // select feedback components
