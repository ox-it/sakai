...
<div class="portletBody">
  ...
  <h:panelGroup rendered="#{delivery.publishedAssessment.assessmentAccessControl.dueDate!=null}">
    <h:outputText value="#{deliveryMessages.no_late_submission_autosubmit_info}" rendered="#{delivery.settings.autoSubmit}" escape="false" />
    <h:outputLabel value="#{deliveryMessages.due_date}: " rendered="#{!delivery.settings.autoSubmit}" />
    <h:outputText value=" #{delivery.deadlineString}" />
  </h:panelGroup> 
