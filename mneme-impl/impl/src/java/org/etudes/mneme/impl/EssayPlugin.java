...
/**
 * EssayPlugin handles the essay question type.
 */
public class EssayPlugin implements QuestionPlugin
{
	private static Log M_log = LogFactory.getLog(EssayPlugin.class);
	...
	{
		return new EssayAnswerImpl(answer, this.attachmentService);
	}
