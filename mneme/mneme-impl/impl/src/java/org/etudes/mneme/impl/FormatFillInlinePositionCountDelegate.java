/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/mneme/branches/MN-1393/mneme-impl/impl/src/java/org/etudes/mneme/impl/FormatFillInlinePositionCountDelegate.java $
 * $Id: FormatFillInlinePositionCountDelegate.java 3635 2012-12-02 21:26:23Z ggolden $
 ***********************************************************************************
 *
...
/**
 * The "FormatFillInlinePositionCount" format delegate for the mneme tool.
 */
public class FormatFillInlinePositionCountDelegate extends FormatDelegateImpl
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(FormatFillInlinePositionCountDelegate.class);
