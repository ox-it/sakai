...
/**
 * FillBlanksPlugin handles the true/false question type.
 */
public class FillBlanksPlugin implements QuestionPlugin
{
	private static Log M_log = LogFactory.getLog(FillBlanksPlugin.class);
	...
	{
		return new FillBlanksAnswerImpl(answer);
	}
