/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/mneme/branches/MN-1145/mneme-impl/impl/src/java/org/etudes/mneme/impl/FormatFillInlinePositionChoiceDelegate.java $
 * $Id: FormatFillInlinePositionChoiceDelegate.java 3635 2012-12-02 21:26:23Z ggolden $
 ***********************************************************************************
 *
...
/**
 * The "FormatFillInlinePositionChoice" format delegate for the mneme tool.
 */
public class FormatFillInlinePositionChoiceDelegate extends FormatDelegateImpl
{
	/** Our log. */
	private static Log M_log = LogFactory.getLog(FormatFillInlinePositionChoiceDelegate.class);
