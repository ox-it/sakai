/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/mneme/branches/MN-1393/mneme-impl/impl/src/java/org/etudes/mneme/impl/FillBlanksPlugin.java $
 * $Id: FillBlanksPlugin.java 3635 2012-12-02 21:26:23Z ggolden $
 ***********************************************************************************
 *
...
/**
 * FillInlinePlugin handles the fill blanks with dropdown type.
 */
public class FillInlinePlugin implements QuestionPlugin
{
	private static Log M_log = LogFactory.getLog(FillInlinePlugin.class);
	...
	{
		return new FillInlineAnswerImpl(answer);
	}
	...
	{
		return new FillInlineQuestionImpl(this, this.messages, this.uiService, question);
	}
