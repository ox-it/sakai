...
INSERT INTO course_component(id, title, termcode, opens, closes, size, taken, administrator, componentId) VALUES('comp-2', 'Lecture on Politics of Mexico', '2010-HIL', DATE_SUB('2010-10-10', INTERVAL 3 WEEK), DATE_SUB('2010-10-10', INTERVAL 1 WEEK), 45, 0, 'd86d9720-eba4-40eb-bda3-91b3145729da', 'tc-2');
INSERT INTO course_component(id, title, termcode, opens, closes, size, taken, administrator, componentId) VALUES('comp-3', 'Seminar on South American Politics', '2010-HIL', DATE_SUB('2010-10-10', INTERVAL 3 WEEK), DATE_SUB('2010-10-10', INTERVAL 1 WEEK), 45, 0, 'd86d9720-eba4-40eb-bda3-91b3145729da', 'tc-3');
...
INSERT INTO course_component(id, title, termcode, opens, closes, size, taken, administrator, componentId) VALUES('comp-6', 'Lecture on Politics of Brazil', '2009-HIL', DATE_SUB('2009-10-10', INTERVAL 3 WEEK), DATE_SUB('2009-10-10', INTERVAL 1 WEEK), 40, 0, 'd86d9720-eba4-40eb-bda3-91b3145729da', 'tc-1');
INSERT INTO course_component(id, title, termcode, opens, closes, size, taken, administrator, componentId) VALUES('comp-7', 'Seminar on South American Politics', '2009-HIL', DATE_SUB('2009-10-10', INTERVAL 3 WEEK), DATE_SUB('2009-10-10', INTERVAL 1 WEEK), 45, 0, 'c10cdf4b-7c10-423c-8319-2d477051a94e', 'tc-3');
...
INSERT INTO course_group_component(course_group, component) VALUES('course-2', 'comp-1');
