...
<link href="../rest/course/all?range=ALL" type="application/json"
	rel="exhibit/data" ex:converter="courseConverter" />
<style type="text/css">
.exhibit-text-facet {
	padding-right: 4px;
	/* Overflows a <table> because of <input> has border and padding */
}
</style>
...
<script src="lib/exhibit/exhibit-api.js?bundle=true"
...
<body>
	<div ex:role="lens" ex:itemTypes="Course" style="display: none">
		<div class="course-item">
			...
			<h3>
				<span ex:if-exists=".newCourse"> <image
						src=/library/image/silk/new.png />
				</span> <span ex:content=".label"></span>
			</h3>
			...
			<form class="details">
				<input type="hidden" name="id" ex:value-content="value"> <input
					type="hidden" name="previous" ex:value-content=".previous">
