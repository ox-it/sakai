...
public class FeedbackLabel extends Label {
	 ...
	 * FeedbackLabel belongs to Generally this is a FormComponent like a
	 * TextField, but can also be the Form itself. Using the form itself is
	 * useful for collecting errors that come from the Form and not from a
	 * FormComponent, like upload too large etc.
	 */
