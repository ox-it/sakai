...
<sakai:view title="#{msgs.tool_title}" id="sakaiview" toolCssHref="/sakai-calendar-summary-tool/summary-calendar/css/cal.css">
	...
	<h:panelGroup>
		<sakai:tool_bar rendered="#{CalBean.userId ne null && CalBean.preferencesVisible}">
			...
			<sakai:tool_bar_item rendered="#{MenuBean.subscribeEnabled}" action="#{MenuBean.processSubscribe}" value="#{msgs['java.opaque_subscribe']}" immediate="true" title="#{msgs['java.opaque_subscribe.title']}" />
		</sakai:tool_bar>
    </h:panelGroup>
