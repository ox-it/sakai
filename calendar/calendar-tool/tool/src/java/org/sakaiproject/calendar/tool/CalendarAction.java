 ...
 */
	...
	boolean allow_subscribe_this)
	{
		...
		if ( sessionManager.getCurrentSessionUserId() != null && (ServerConfigurationService.getBoolean("ical.public.secureurl.subscribe", ServerConfigurationService.getBoolean("ical.opaqueurl.subscribe", true))) )
		{
