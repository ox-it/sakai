...
<script type="text/javascript">
	...
	$(function() {
						...
						"aoColumns" : [
								...
								},
								{
									...
									"fnRender" : function(aObj) {
										if (aObj.aData[5]) {
											return '<a class="more-details-link" href="'+aObj.aData[4]+'"><image src="/library/image/silk/new.png" />'
													+ aObj.aData[1] + '</a>';
										} else {
											return '<a class="more-details-link" href="'+aObj.aData[4]+'">'
													+ aObj.aData[1] + '</a>';
										}
									},
									"bSortable" : false
							...
							jQuery.ajax({
								...
								success : function(result) {
									...
									$.each(result, function() {
										...
										var starts = "unknown";
										var summaryObj = Signup.signup.summary(
												this.components, recentDays);
		...
		var table = $("#ses-calendar").myTable("../rest/course/nodates");
		Signup.util.autoresize();

		$("input.filter-button", this)
				.die()
				.live(
						"click",
						function(e) {
							var selectElement = document
									.getElementById("filterByProvider");
		...
		$("a.more-details-link", this).die().live(
				"click",
				function(e) {
					e.preventDefault();
					try {
						...
						var height = Math
								.round($(workingWindow).height() * 0.9);
