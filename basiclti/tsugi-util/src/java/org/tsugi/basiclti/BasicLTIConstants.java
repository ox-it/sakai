...
public class BasicLTIConstants {
    ...
    * The Tool Provider should be flexible when parsing this field.  This parameter is optional but recommended.
	...
	public static final String[] validPropertyNames = { CONTEXT_ID,
		...
		ACCEPT_MEDIA_TYPES, ACCEPT_PRESENTATION_DOCUMENT_TARGETS, CONTENT_ITEM_RETURN_URL,
		ACCEPT_UNSIGNED, ACCEPT_MULTIPLE, ACCEPT_COPY_ADVICE, AUTO_CREATE, CAN_CONFIRM,
		TITLE, TEXT, DATA, EXT_SAKAI_PROVIDER_EID, EXT_SAKAI_PROVIDER_DISPLAYID
	};
