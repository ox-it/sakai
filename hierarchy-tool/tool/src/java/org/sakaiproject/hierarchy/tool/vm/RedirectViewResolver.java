...
/**
 * Very similar to UrlBasedViewResolver but if it doesn't seem to be a redirect or
 * forward view let another view resolver have a go.
 * @author buckett
 *
 */
public class RedirectViewResolver extends UrlBasedViewResolver implements Ordered {
	...
	/**
	 * Don't need to specify class as we only ever deal with redirect and forward prefixes.
	 */
