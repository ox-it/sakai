...
public class CreateSiteController extends AbstractCommandController {
	...
	@Override
	protected ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object object,
	...
	/**
	 * Handle failure in the creation of the node in the hierarchy. Cleans up
