...
public class UnitTestUtilities {
	...
	/**
	 * For the routing to work correctly we need to have a context set and the
	 * pathinfo being part of the request uri. Without this the wrong matching
	 * got done in {@link
	...
	/**
	 * Simple alert contains but we send what we failed to find back in the
	 * message. This makes debugging much easier.
	 * 
	 * @param looking
	 *            The string we're looking for.
	 * @param source
	 *            The string that should contain the string we're looking for.
	 */
