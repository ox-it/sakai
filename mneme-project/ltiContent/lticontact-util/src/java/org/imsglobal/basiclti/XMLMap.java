/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/tags/2.9.4/melete-util/src/java/org/imsglobal/basiclti/XMLMap.java $
 * $Id: XMLMap.java 3641 2012-12-02 21:43:44Z ggolden $
 **********************************************************************************
 *
...
public class XMLMap {
	...
	private static Map<String,Object> getObjectMap(Document doc, boolean doFull)
	{
		if ( doc == null ) return null;
